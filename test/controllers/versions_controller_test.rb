...
class VersionsControllerTest < ActionController::TestCase
  ...
  test "should create version" do
    assert_difference('Version.count') do
      post :create, version: { content: @version.content, current: @version.current, version_date: @version.version_date }
    end
  ...
  test "should update version" do
    patch :update, id: @version, version: { content: @version.content, current: @version.current, version_date: @version.version_date }
    assert_redirected_to version_path(assigns(:version))
  end
